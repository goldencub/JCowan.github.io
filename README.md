...
🖥️ Home Lab — Virtualised Network & Security Environment
...
Networking	Subnetting, VLANs, VLSM, ACLs, Cisco IOS, Packet Tracer
Security	Kali Linux, Nmap, WPScan, Wireshark, Netdiscover
Virtualisation	VirtualBox, pfSense, Ubuntu Server
Monitoring	Wireshark, packet capture and analysis
Scripting	Python (network automation)
Certifications & Training
Cert IV in Cybersecurity (in progress)
CompTIA Network+ (in progress)
CompTIA Security+ (in progress)
SOC Core Skills — Antisyphon Training (John Strand)
